...
# for i in range(16):
#     if s[i*16: i*16+16]!=S_BOX[i]:
#         print(s[i*16: i*16+16], S_BOX[i])
# print([s[i*16: i*16+16] for i in range(16)]==S_BOX)
...
if __name__ == '__main__':
    ...
    aes = AES()
    key = int("WHAT_THIS_A_401\x01".encode().hex(), 16)
    # key = 0x574841545f544849535f415f34303101
    print(hex(key))
    ...
    flag = b""
    # 解密
    ciphertext = 0xF17A9DFDF5CA373D521479ED51BEAEEE
    ...
    print(flag)
    ciphertext = 0xCD710EA26A0CFACBB54BF5925809591B
    ciphertext = aes.num_2_16bytes(ciphertext)
    plaintext = aes.aes_decrypt(ciphertext, RoundKeys)
    flag += bytes.fromhex(hex(aes._16bytes2num(plaintext))[2:])
    print(flag)
